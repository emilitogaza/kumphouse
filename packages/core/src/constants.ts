import type { KumphouseColumn, KumphouseTabs, UserConfig } from './types'
...
export const DefaultColumns: Record<KumphouseTabs, KumphouseColumn[]> = {
  'overview': [
    {
  ...
  'performance': [
    ...
    },
    {
      ...
      label: 'FID',
      warning: true,
      tooltip: 'Warning: This is deprecated in favour if INP which is not yet supported by Kumphouse. The maximum potential First Input Delay that your users could experience is the duration of the longest task. [Learn more](https://web.dev/lighthouse-max-potential-fid/).',
      sortKey: 'numericValue',
