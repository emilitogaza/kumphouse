import type { KumphouseRouteReport } from '../types'
...
export function csvSimpleFormat(reports: KumphouseRouteReport[]): { headers: string[], body: any } {
...
export function reportCSVSimple(reports: KumphouseRouteReport[]): string {
