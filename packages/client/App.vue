...
useTitle(`${website.replace(/https?:\/\/(www.)?/, '')} | Kumphouse`)
                ...
                <span class="inline-flex items-center space-x-1">
                  ...
                  <tooltip v-if="category.label === 'Performance'" class="text-left">
                    ...
                    <template #tooltip>
                      ...
                      <div>Kumphouse is running <span class="underline">with{{ throttle ? '' : 'out' }} throttling</span> which will also effect scores.</div>
                    </template>
                  </tooltip>
                </span>
              ...
              <div class="flex items-center justify-center space-x-3 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                ...
                <div class="text-center">
                  ...
                  <p class="text-sm text-red-700 dark:text-red-300 mt-1">
                    Kumphouse CrUX API is currently unavailable.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="w-full min-w-[1500px] pr-3 overflow-y-auto xl:max-h-[calc(100vh-100px)] lg:max-h-[calc(100vh-205px)] sm:max-h-[calc(100vh-220px)] max-h-[calc(100vh-250px)]">
              <div v-if="Object.values(searchResults).length === 0" class="px-4 py-3">
                  ...
                  <div class="flex items-center space-x-3 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                    ...
                    <div>
                      ...
                      <p class="text-sm text-yellow-700 dark:text-yellow-300 mt-1">
                        The Kumphouse client is running but cannot connect to the server.
                        Please ensure the Kumphouse server is running and accessible.
                      </p>
                    </div>
                  </div>
                </template>
                ...
                <div v-else class="flex items-center">
                  ...
                  <div>
                    <p aria-live="polite">
                      Tar tag i problemen — waiting for routes...
                    </p>
                    <span class="text-xs opacity-50">If this hangs, run Kumphouse with --debug. Every problem-solver needs a stack trace.</span>
                  </div>
                </div>
              </div>
                ...
                <div class="mb-6">
                  <template v-if="isStatic">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                      This is a static Kumphouse client with no report data.
                      Generate reports using the Kumphouse CLI to see results here.
                    </p>
                  </template>
                  <template v-else>
      ...
      <footer class="block xl:hidden my-2">
        <div class="px-2 text-center xl:text-left">
          <div class="flex items-center justify-around">
            <div class="text-xs opacity-75 xl:mt-4">
              <a href="https://kumpan.se" target="_blank" class="underline">Kumphouse</a> — solved by <a href="https://kumpan.se" target="_blank" class="underline">Kumpan</a>
            </div>
            <div class="text-xs opacity-75 xl:mt-4">
              Forked with <UIcon name="i-simple-line-icons-heart" title="Love" class="inline" aria-label="love" /> from <a href="https://unlighthouse.dev" target="_blank" class="underline">Unlighthouse</a> by <a href="https://twitter.com/harlan_zw" target="_blank" class="underline">@harlan_zw</a>
            </div>
          </div>
          <div class="text-xs opacity-50 xl:mt-4 mt-1">
