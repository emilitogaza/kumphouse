...
description: "Complete reference for all Kumphouse configuration options including types, defaults, and usage examples."
keywords:
  - kumphouse config
  - kumphouse options
  - kumphouse configuration
...
Complete reference for all Kumphouse configuration options with types, defaults, and usage examples. For implementation guides, see [Configuration Guide](/guide/guides/config) or [CLI Arguments](/integrations/cli#configuration).
...
- **Type:** `NestedHooks<KumphouseHooks>`{lang="ts"}
- **Default:** `{}`{lang="ts"}
...
Change the behaviour of kumphouse in CI mode.
...
Combine this with uploading to a site, and you can see the results of your kumphouse scan on a live site.
...
- **Type:** `Record<KumphouseTabs, KumphouseColumn[]>`{lang="ts"}
