...
description: "Modify Kumphouse client interface columns and display to show custom metrics and data."
keywords:
...
Customize the Kumphouse dashboard to display metrics relevant to your workflow. Replace default columns, add custom audit displays, and configure how results appear.
