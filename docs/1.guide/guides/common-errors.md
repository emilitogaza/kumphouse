---
title: "Common Errors"
description: "Troubleshoot common issues encountered when running Kumphouse scans, including browser connection and environment problems."
keywords:
  - lighthouse error
...
Solutions for frequently encountered issues when running Kumphouse scans. Ensure you're using the latest version before troubleshooting.
