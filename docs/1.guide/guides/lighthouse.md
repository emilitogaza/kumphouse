...
description: "Customize Google Lighthouse audit settings, categories, and performance thresholds within Kumphouse scans."
keywords:
  - lighthouse options
...
Customize audit categories, performance thresholds, and behavior through the `lighthouseOptions` configuration key. Kumphouse passes these options directly to Google Lighthouse.
...
Kumphouse aims to minimise and simplify configuration, where possible.
...
By default, Kumphouse will scan the categories: `'performance', 'accessibility', 'best-practices', 'seo'`.
...
It can be useful to remove certain categories from being scanned to improve scan times. The Kumphouse UI will adapt
