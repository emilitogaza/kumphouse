...
description: "Debug and troubleshoot Kumphouse scans using logging, browser inspection, and diagnostic tools."
keywords:
  - lighthouse debug
...
Now you'll see exactly what Kumphouse sees—useful for:
