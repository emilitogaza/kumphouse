---
title: "URL Discovery"
description: "How Kumphouse discovers pages using sitemaps, robots.txt, and internal link crawling. Configure URL sources and filters."
keywords:
  - lighthouse sitemap
...
Kumphouse automatically finds all pages on your site using multiple discovery methods. Configure which sources to use and filter results to scan exactly what you need.

Kumphouse discovers URLs through multiple methods:
...
```bash
kumphouse --site https://example.com --urls /about,/other-page
```
