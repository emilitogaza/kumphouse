...
relatedPages:
  - path: /guide/getting-started/kumphouse-cli
    title: Kumphouse CLI
...
Use [Kumphouse CLI](/guide/getting-started/kumphouse-cli) to audit all these metrics across your entire website in a single scan:

```bash
npx kumphouse --site https://example.com
```

Unlike single-page tools like PageSpeed Insights, Kumphouse scans your entire site and identifies which pages need the most attention.
