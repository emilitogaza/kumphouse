...
[Kumphouse](/guide/getting-started/kumphouse-cli) reports responsiveness metrics across your site. For INP specifically, you need field data since it measures real user interactions.
